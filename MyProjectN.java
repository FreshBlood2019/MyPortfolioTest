...
public class MyProjectN {
    private static final String MYPORTFOLIONATALLIA_MAIN_PAGE_URL = "http://www.natalliaportfolio.com/";
    WebDriver driver;
    //1. Open a browser
    //2. Go to MyPorfolioNatallia main page
    ...
    private void goToMainPage() {
        driver.get(MYPORTFOLIONATALLIA_MAIN_PAGE_URL);
    }
    ...
    private void completeFieldsName() {
        driver.findElement(By.id("name")).sendKeys("Your New Job");
    }
    private void completeFieldsEmail() {
        driver.findElement(By.id("email")).sendKeys("dreamjob2021@gmail.com");
    }
